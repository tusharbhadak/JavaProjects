 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/SampleWebSeviceApp/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://service/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SampleWebSeviceApp/HelloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://service/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "HelloServicePort"), HelloService.class, features);
    }
